...
<?php endif; ?>
     ...
     <form method="POST" action="<?php echo e(route('register')); ?>">
      ...
      <div class="form-group has-feedback">
        <input type="text" name="name" id="name" class="form-control" placeholder="Full Name" value="<?php echo e(old('name')); ?>" required autofocus autocomplete="name">
...
<?php endif; ?>
      ...
      <div class="form-group has-feedback">
        <input type="email" name="email" id="email" class="form-control" placeholder="Email" value="<?php echo e(old('email')); ?>" required autocomplete="username">
...
<?php endif; ?>
    ...
    <div class="mt-5">
        Already have an account ? <a href="<?php echo e(route('login')); ?>" class="text-center">Sign In Here</a>
    </div>
  </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\carbook\resources\views/auth/register.blade.php ENDPATH**/ ?>