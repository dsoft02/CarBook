...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo e(route('user.bookings.index')); ?>">Manage Bookings</a></li>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        <a href="<?php echo e(route('user.bookings.index')); ?>" class="btn bg-navy" title="" data-original-title="Back">
...
<?php echo $__env->make('user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\carbook\resources\views/user/bookings/show.blade.php ENDPATH**/ ?>