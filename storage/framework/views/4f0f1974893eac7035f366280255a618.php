...
<?php endif; ?>
        ...
        <?php endif; ?>
        Do not have an account ? <a href="<?php echo e(route('register')); ?>" class="text-center">Sign Up Here</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\carbook\resources\views/auth/login.blade.php ENDPATH**/ ?>