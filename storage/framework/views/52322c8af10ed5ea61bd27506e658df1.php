            ...
            <nav class="navbar navbar-static-top" role="navigation">
                  ...
                  <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                              ...
                              <li>
                                    <a href="<?php echo e(route('admin.contacts')); ?>" title="Messages"><i class="fa fa-envelope-o"></i></a>
                              </li>
                              <!-- /.messages-menu -->
                              <!-- User Account Menu -->
...
<?php /**PATH C:\xampp\htdocs\carbook\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>