        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-9">
                            <form id="userForm" method="POST" action="<?php echo e(route('admin.users.store')); ?>"
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <input type="email" id="email" name="email" class="form-control"
                                                   placeholder="email@sample.com" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <select id="role" name="role" class="form-control">
                                                ...
                                                'role', 'customer') == 'customer') ? 'selected' : ''); ?>>Customer</option>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\carbook\resources\views/admin/users/create.blade.php ENDPATH**/ ?>