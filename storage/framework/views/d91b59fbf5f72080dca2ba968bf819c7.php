                    ...
                    <div class="box-header with-border">
                         ...
                         <!-- tools box -->
                          <div class="pull-right box-tools">
                                <a href="<?php echo e(route('admin.cars.index')); ?>" class="btn bg-navy" title="" data-original-title="Back">
                                <i class="fa fa-undo"> </i> Back</a>
                          </div>
                          <!-- /. tools -->
                    </div>
                    <!-- /.box-header -->
                    <form id="carForm" role="form" action="<?php echo e(route('admin.cars.update', $car->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                          ...
                                          <input type="text" class="form-control" id="carName" name="name" value="<?php echo e(old('name', $car->name)); ?>" required>
                                          ...
                                          <label class="control-label" for="carBrand">Brand <span class="text-danger">*</span></label>
                                            <select class="form-control select2" id="carBrand" name="brand_id" style="width:100%" required>
                                                  ...
                                                  <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                     <option value="<?php echo e($brand->id); ?>" <?php echo e((old('brand_id') == $brand->id || (isset($car) && $car->brand_id == $brand->id)) ? 'selected' : ''); ?>>
                                          ...
                                          <label class="control-label" for="carModel">Model <span class="text-danger">*</span></label>
                                            <select class="form-control select2" id="carModel" name="car_model_id" style="width:100%" required>
                                                  ...
                                                  <?php $__currentLoopData = $carModels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carModel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                     <option value="<?php echo e($carModel->id); ?>" <?php echo e((old('car_model_id') == $carModel->id || (isset($car) && $car->car_model_id == $carModel->id)) ? 'selected' : ''); ?>>
                                          ...
                                          <label class="control-label" for="year">Year <span class="text-danger">*</span></label>
                                            <select class="form-control select2" id="year" name="year" style="width:100%">
                                                ...
                                                <?php for($year = date('Y'); $year >= 1900; $year--): ?>
                                                    <option value="<?php echo e($year); ?>" <?php echo e((old('year') == $year || (isset($car) && $car->year == $year)) ? 'selected' : ''); ?>>
                                                        <?php echo e($year); ?>
                                          ...
                                          <label class="control-label" for="seatType">Seat Type <span class="text-danger">*</span></label>
                                            <select class="form-control select2" id="seatType" name="seat_type_id" style="width:100%" required>
                                                  ...
                                                  <?php $__currentLoopData = $seatTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seatType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($seatType->id); ?>" <?php echo e((old('seat_type_id') == $seatType->id || (isset($car) && $car->seat_type_id == $seatType->id)) ? 'selected' : ''); ?>>
                                                        <?php echo e($seatType->name); ?>
...
unset($__errorArgs, $__bag); ?>">
                                          ...
                                          <input type="text" class="form-control" id="fuel_type" name="fuel_type"  value="<?php echo e(old('fuel_type', $car->fuel_type)); ?>">
...
unset($__errorArgs, $__bag); ?>">
                                          ...
                                          <input type="text" class="form-control" id="color" name="color" value="<?php echo e(old('color', $car->color)); ?>" required>
...
unset($__errorArgs, $__bag); ?>">
                                          ...
                                          <input type="text" class="form-control number" id="doors" name="doors" value="<?php echo e(old('doors', $car->doors)); ?>" required>
...
unset($__errorArgs, $__bag); ?>">
                                          ...
                                          <input type="text" class="form-control" id="transmission" name="transmission" value="<?php echo e(old('transmission', $car->transmission)); ?>" required>
...
unset($__errorArgs, $__bag); ?>">
                                          ...
                                          <input type="text" class="form-control" id="mileage" name="mileage" value="<?php echo e(old('mileage', $car->mileage)); ?>" required>
...
unset($__errorArgs, $__bag); ?>">
                                          <label class="control-label" for="status">Visibility Status</label>
                                            <select class="form-control" id="status" name="status">
                                              <option value="1" <?php echo e((old('status') === 1 || (isset($car) && $car->status === 1)) ? 'selected' : ''); ?>>Active</option>
                                              <option value="0" <?php echo e((old('status') === 0 || (isset($car) && $car->status === 0)) ? 'selected' : ''); ?>>Inactive</option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>">
                                          ...
                                          <input type="text" class="form-control number" id="price" name="price" value="<?php echo e(old('price', $car->price)); ?>" required>
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <select class="form-control" id="is_featured" name="is_featured">
                                                <option value="1" <?php echo e((old('is_featured') === 1 || (isset($car) && $car->is_featured === 1)) ? 'selected' : ''); ?>>Yes</option>
                                                <option value="0" <?php echo e((old('is_featured') === 0 || (isset($car) && $car->is_featured === 0)) ? 'selected' : ''); ?>>No</option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>">
                                          <label class="control-label" for="description">Description</label>
                                            <textarea id="description" name="description" rows="10" cols="80"><?php echo e(old('description', $car->description)); ?></textarea>
                                ...
                                <div class="row">
                                                ...
                                                <?php if(isset($car) && $car->images): ?>
                                                    ...
                                                    <?php if(is_array($images) && count($images) > 0): ?>
                                                        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="image-preview" data-index="<?php echo e($index); ?>">
                                                                <img src="<?php echo e(asset('storage/' . $image)); ?>" alt="Car Image">
                                                                <button type="button" class="remove-btn" onclick="removeExistingImage(<?php echo e($index); ?>)">&times;</button>
                                 ...
                                 <div class="row">
                                    ...
                                    <?php $__currentLoopData = $carFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carFeature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <input type="checkbox" name="car_features[]" class="minimal-red" value="<?php echo e($carFeature->id); ?>" <?php echo e(in_array($carFeature->id, old('car_features', $selectedFeatures)) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\carbook\resources\views/admin/cars/edit.blade.php ENDPATH**/ ?>