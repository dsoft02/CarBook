            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <div class="pull-right box-tools">
                        <a href="<?php echo e(route('user.contacts.create')); ?>" class="btn bg-navy" title=""
                ...
                <div class="box-body">
                    <table id="list-table" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('user.contacts.view', $contact->id)); ?>" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> View</a>
...
<?php echo $__env->make('user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\carbook\resources\views/user/contacts/index.blade.php ENDPATH**/ ?>