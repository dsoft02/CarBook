...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('user.bookings.index') }}">Manage Bookings</a></li>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        <a href="{{ route('user.bookings.index') }}" class="btn bg-navy" title="" data-original-title="Back">
                        ...
                        <div class="col-lg-6 align-self-start pt-3">
                            <div class="rent__single">
                                ...
                                <div class="btn__grp mt-3">
                                    ...
                                    <form action="{{ route('user.bookings.complete', $booking->id) }}" method="POST"
                                          style="display:inline;">
                                        @csrf
