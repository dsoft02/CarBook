    ...
    <div class="row">
        <div class="col-xs-12">
              <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <form id="carForm" role="form" action="{{ route('admin.cars.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                          <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group @error('name') has-error @enderror">
                                          ...
                                          <input type="text" class="form-control" id="carName" name="name" value="{{ old('name') }}" required>
                                            @error('name')
                                          ...
                                          <label class="control-label" for="carModel">Model <span class="text-danger">*</span></label>
                                            <select class="form-control select2" id="carModel" name="car_model_id" style="width:100%" required>
                                                  ...
                                                  @foreach($carModels as $carModel)
                                                     <option value="{{ $carModel->id }}" {{ old('car_model_id') == $carModel->id ? 'selected' : '' }}>
                                                        {{ $carModel->name }}
                                                    </option>
                                                  @endforeach
                                            </select>
                                          ...
                                          <label class="control-label" for="seatType">Seat Type <span class="text-danger">*</span></label>
                                            <select class="form-control select2" id="seatType" name="seat_type_id" style="width:100%" required>
                                                  ...
                                                  @foreach($seatTypes as $seatType)
                                                    <option value="{{ $seatType->id }}" {{ old('seat_type_id') == $seatType->id ? 'selected' : '' }}>{{ $seatType->name }}</option>
                                                  @endforeach
                                            </select>
                                            @error('seat_type_id')
                                                <span class="help-block">{{ $message }}</span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group @error('doors') has-error @enderror">
                                          ...
                                          <input type="text" class="form-control number" id="doors" name="doors" value="{{ old('doors') }}" required>
                                            @error('doors')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group @error('transmission') has-error @enderror">
                                          ...
                                          <input type="text" class="form-control" id="transmission" name="transmission" value="{{ old('transmission') }}" required>
                                            @error('transmission')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group @error('mileage') has-error @enderror">
                                          ...
                                          <input type="text" class="form-control" id="mileage" name="mileage" value="{{ old('mileage') }}" required>
                                            @error('mileage')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group @error('price') has-error @enderror">
                                          ...
                                          <input type="text" class="form-control number" id="price" name="price" value="{{ old('price') }}" required>
                                            @error('price')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                    ...
                                    @foreach($carFeatures as $carFeature)
                                        ...
                                        <input type="checkbox" name="car_features[]" class="minimal-red" value="{{ $carFeature->id }}" {{ in_array($carFeature->id, old('car_features', [])) ? 'checked' : '' }}>
                                        {{ $carFeature->name }}
                                        </label>
                                    @endforeach
                                    <!-- /.col -->
